...
const ContinentalMenu = () => {
  ...
  const fetchBreakfastItems = async () => {
    try {
      const response = await fetch('http://localhost:8100/continental/breakfast');
      if (response.ok) {
  ...
  const fetchCurriesItems = async () => {
    try {
      const response = await fetch('http://localhost:8100/continental/curries');
      if (response.ok) {
        const data = await response.json();
  ...
  const fetchSoupsItems = async () => {
    try {
      const response = await fetch('http://localhost:8100/continental/soups');
      if (response.ok) {
        const data = await response.json();
  ...
  const fetchStartersItems = async () => {
    try {
      const response = await fetch('http://localhost:8100/continental/starters');
      if (response.ok) {
        const data = await response.json();
  ...
  const fetchMainCourseItems = async () => {
    try {
      const response = await fetch('http://localhost:8100/continental/maincourse');
      if (response.ok) {
        const data = await response.json();
  ...
  const fetchDessertsItems = async () => {
    try {
      const response = await fetch('http://localhost:8100/continental/desserts');
      if (response.ok) {
        const data = await response.json();
  ...
  const fetchDrinksItems = async () => {
    try {
      const response = await fetch('http://localhost:8100/continental/drinks');
      if (response.ok) {
        const data = await response.json();
  ...
  const deleteBreakfastItem = async (itemName,customerid) => {
    try {
      ...
      const response = await axios.delete(`http://localhost:8100/continental/food/${customerid}`);
  ...
  const updateBreakfastItem = async (itemName,customerid) => {
    try {
      ...
      const response = await axios.update(`http://localhost:8100/continental/food/${customerid}`);
  ...
  return (
    <>
          ...
          <tbody>
            {breakfastItems.map((item, index) => (
              <tr key={index}>
                ...
                <td>
                <Link Link to={`/updatecontinentalbreakfast/${item.customerid}`}>
      ...
      <div>
        <Link to={'/AddContinentalBreakfast'}>
    ...
    <tbody>
      {curriesItems.map((item, index) => (
        <tr key={index}>
          ...
          <td>
          <Link Link to={`/updatecontinentalcurries/${item.customerid}`}>
    ...
    <tbody>
      {soupsItems.map((item, index) => (
        <tr key={index}>
          ...
          <td>
          <Link Link to={`/updatecontinentalsoups/${item.customerid}`}>
    ...
    <tbody>
      {startersItems.map((item, index) => (
        <tr key={index}>
          ...
          <td>
          <Link Link to={`/updatecontinentalstarters/${item.customerid}`}>
...
<div>
  <Link to={'/AddContinentalStarters'}>
    <button className="s" onClick={() => addToCart()}>
      Add
    </button>
  </Link>
...
<div>
  <h3>Continental Main Courses</h3>
  <table>
    <thead>
      <tr>
        <th>Main Course</th>
    ...
    <tbody>
      {mainCourseItems.map((item, index) => (
        <tr key={index}>
          ...
          <td>
          <Link Link to={`/updatecontinentalmaincourse/${item.customerid}`}>
...
<div>
  <Link to={'/AddContinentalMainCourse'}>
    <button className="s" onClick={() => addToCart()}>
      Add
    </button>
  </Link>
    ...
    <tbody>
      {dessertsItems.map((item, index) => (
        <tr key={index}>
          ...
          <td>
          <Link Link to={`/updatecontinentaldesserts/${item.customerid}`}>
...
<div>
  <Link to={'/AddContinentalDesserts'}>
    <button className="s" onClick={() => addToCart()}>
      Add
    </button>
  </Link>
    ...
    <tbody>
      {drinksItems.map((item, index) => (
        <tr key={index}>
          ...
          <td>
          <Link Link to={`/updatecontinentaldrinks/${item.customerid}`}>
