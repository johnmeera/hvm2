...
const ChineaseMenu = () => {
  ...
  const fetchBreakfastItems = async () => {
    try {
      const response = await fetch('http://localhost:8100/chinease/breakfast');
      if (response.ok) {
  ...
  const fetchCurriesItems = async () => {
    try {
      const response = await fetch('http://localhost:8100/chinease/curries');
      if (response.ok) {
        const data = await response.json();
  ...
  const fetchSoupsItems = async () => {
    try {
      const response = await fetch('http://localhost:8100/chinease/soups');
      if (response.ok) {
        const data = await response.json();
  ...
  const fetchStartersItems = async () => {
    try {
      const response = await fetch('http://localhost:8100/chinease/starters');
      if (response.ok) {
        const data = await response.json();
  ...
  const fetchMainCourseItems = async () => {
    try {
      const response = await fetch('http://localhost:8100/chinease/maincourse');
      if (response.ok) {
        const data = await response.json();
  ...
  const fetchDessertsItems = async () => {
    try {
      const response = await fetch('http://localhost:8100/chinease/desserts');
      if (response.ok) {
        const data = await response.json();
  ...
  const fetchDrinksItems = async () => {
    try {
      const response = await fetch('http://localhost:8100/chinease/drinks');
      if (response.ok) {
        const data = await response.json();
  ...
  const deleteBreakfastItem = async (itemName,customerid) => {
    try {
      ...
      const response = await axios.delete(`http://localhost:8100/chinease/food/${customerid}`);
  ...
  const updateBreakfastItem = async (itemName,customerid) => {
    try {
      ...
      const response = await axios.update(`http://localhost:8100/chinease/food/${customerid}`);
          ...
          <tbody>
            {breakfastItems.map((item, index) => (
              <tr key={index}>
                ...
                <td>
                <Link Link to={`/updatechineasebreakfast/${item.customerid}`}>
  ...
  <tbody>
    {curriesItems.map((item, index) => (
      <tr key={index}>
        ...
        <td>
        <Link Link to={`/updatechineasecurries/${item.customerid}`}>
  ...
  <tbody>
    {soupsItems.map((item, index) => (
      <tr key={index}>
        ...
        <td>
        <Link Link to={`/updatechineasesoups/${item.customerid}`}>
    ...
    <tbody>
      {startersItems.map((item, index) => (
        <tr key={index}>
          ...
          <td>
          <Link Link to={`/updatechineasestarters/${item.customerid}`}>
    ...
    <tbody>
      {mainCourseItems.map((item, index) => (
        <tr key={index}>
          ...
          <td>
          <Link Link to={`/updatechineasemaincourse/${item.customerid}`}>
    ...
    <tbody>
      {dessertsItems.map((item, index) => (
        <tr key={index}>
          ...
          <td>
          <Link Link to={`/updatechineasedesserts/${item.customerid}`}>
    ...
    <tbody>
      {drinksItems.map((item, index) => (
        <tr key={index}>
          ...
          <td>
          <Link Link to={`/updatechineasedrinks/${item.customerid}`}>
