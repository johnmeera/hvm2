...
function CD() {
  ...
  const handleSubmit = (e) => {
    ...
    // axios.post('http://localhost:8080/api-v1/create', formData)
     axios.put('http://localhost:8080/api-v1/update/3', formData)
      .then(response => {
  ...
  return (
    <>
       ...
       <img  className="img31" src="https://www.millenniumparkpanchgani.com/mobile/images/room/executive-suite-1.jpg" alt="loading.." width="50cm" height="30cm" style={{ marginLeft: "25cm", marginTop: "4cm", float: "inline-end", marginRight: "1cm",width:"11cm", height:"8cm" }} /><br /> 
