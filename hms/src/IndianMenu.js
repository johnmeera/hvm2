...
const IndianMenu = () => {
  ...
  const fetchBreakfastItems = async () => {
    try {
      const response = await fetch('http://localhost:8100/indian/breakfast');
      if (response.ok) {
  ...
  const fetchCurriesItems = async () => {
    try {
      const response = await fetch('http://localhost:8100/indian/curries');
      if (response.ok) {
        const data = await response.json();
  ...
  const fetchSoupsItems = async () => {
    try {
      const response = await fetch('http://localhost:8100/indian/soups');
      if (response.ok) {
        const data = await response.json();
  ...
  const fetchStartersItems = async () => {
    try {
      const response = await fetch('http://localhost:8100/indian/starters');
      if (response.ok) {
        const data = await response.json();
  ...
  const fetchMainCourseItems = async () => {
    try {
      const response = await fetch('http://localhost:8100/indian/maincourse');
      if (response.ok) {
        const data = await response.json();
  ...
  const fetchDessertsItems = async () => {
    try {
      const response = await fetch('http://localhost:8100/indian/desserts');
      if (response.ok) {
        const data = await response.json();
  ...
  const fetchDrinksItems = async () => {
    try {
      const response = await fetch('http://localhost:8100/indian/drinks');
      if (response.ok) {
        const data = await response.json();
  ...
  const deleteBreakfastItem = async (itemName,customerid) => {
    try {
      ...
      const response = await axios.delete(`http://localhost:8100/indian/food/${customerid}`);
  ...
  const updateBreakfastItem = async (itemName,customerid) => {
    try {
      ...
      const response = await axios.update(`http://localhost:8100/indian/food/${customerid}`);
  ...
  return (
    <>
      <div className="indian-menu-container">
      <Link to={'/Restaurant'}>
          ...
          <tbody>
            {breakfastItems.map((item, index) => (
              <tr key={index}>
                ...
                <td>
                  <Link Link to={`/updateindianbreakfast/${item.customerid}`}>
    ...
    <tbody>
      {curriesItems.map((item, index) => (
        <tr key={index}>
          ...
          <td>
          <Link Link to={`/updateindiancurries/${item.customerid}`}>
    ...
    <tbody>
      {soupsItems.map((item, index) => (
        <tr key={index}>
          ...
          <td>
          <Link Link to={`/updateindiansoups/${item.customerid}`}>
    ...
    <tbody>
      {startersItems.map((item, index) => (
        <tr key={index}>
          ...
          <td>
          <Link Link to={`/updateindianstarters/${item.customerid}`}>
    ...
    <tbody>
      {mainCourseItems.map((item, index) => (
        <tr key={index}>
          ...
          <td>
          <Link Link to={`/updateindianmainCourse/${item.customerid}`}>
    ...
    <tbody>
      {dessertsItems.map((item, index) => (
        <tr key={index}>
          ...
          <td>
          <Link Link to={`/updateindiandesserts/${item.customerid}`}>
    ...
    <tbody>
      {drinksItems.map((item, index) => (
        <tr key={index}>
          ...
          <td>
          <Link Link to={`/updateindiandrinks/${item.customerid}`}>
