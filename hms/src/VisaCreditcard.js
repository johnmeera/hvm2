...
function VisaCreditcard(){
  ...
  const navigate = useNavigate();
    ...
    if (card === "4315813922446008" && expiry === "02/30" && cvv === "230" && cardHolderName.trim() !== "") {
    ...
    return(
        ...
        <form className="formn" style={{
          ...
          border: "2px solid black", // Border color of the form
            ...
            <h1 style={{marginLeft:"5.5cm",color:"black"}}><b>Credit card Details </b></h1><br/>

            <label style={{marginLeft:"2cm",fontSize:"larger",color:"black"}}><b>Enter your Credit card number:</b></label><br/>
