...
function UpdateChineaseStarters() {
                ...
                <div className="updateitems-container">
                        ...
                        <div className="su" type="Starters">
                                ...
                                <option value="Veg Paneer Tikka">Veg Paneer Tikka</option>
                                    <option value="Chilli Paneer Dry">Chilli Paneer Dry</option>
                                    <option value="Chicken Manchurian Dry">Chicken Manchurian Dry</option>
...
export default UpdateChineaseStarters;
