...
function PS() {
  ...
  const handleSubmit = (e) => {
    ...
    axios.put('http://localhost:8080/api-v1/update/2', formData)
      .then(response => {
  ...
  return (
    <>
       ...
       <img  className="img31" src="https://www.parkregisgoa.in/wp-content/uploads/2021/04/Presidential-Suite-2-2520x1400.jpg" alt="loading.." width="50cm" height="30cm" style={{ marginLeft: "25cm", marginTop: "3.4cm", float: "inline-end", marginRight: "1cm",width:"11cm", height:"8cm" }} /><br /> 
     
       
       <div style={{ marginTop: "0.5cm", marginLeft: "9cm", float: "inline-start" }}>
