        ...
        height: "100vh",
         ...
         <form className="formn" style={{
          ...
          marginBottom:"-4cm"
            ...
            <h1 style={{marginLeft:"5.5cm",marginTop:"2cm",color:"black"}}><b>Debit Card Payment</b></h1><br/><br/><br/>

            <p  style={{marginLeft:"3cm",color:"black"}}><b>Debit Card Payments Banks</b></p><br/>
            <Link to={'/RupayDebitcard'}>
            <button type="button"  className="btn btn-light" style={{marginTop:"0.5cm",width:"3cm",height:"1cm",marginLeft:"4cm",float:"left",backgroundColor:"white",border:"1px solid black"}}><b><img src="https://img.etimg.com/thumb/width-1200,height-1200,imgsize-12610,resizemode-75,msid-106297731/wealth/personal-finance-news/indias-first-corporate-credit-card-on-rupay-network-launched-upi-transactions-and-more.jpg" width="109cm" height="33cm" style={{marginLeft:"0cm",marginTop:"-0.28cm",width:"2cm"}}></img></b></button>  
            </Link>
            <Link to={'/VisaDebitcard'}>
            <button type="button"  className="btn btn-light" style={{width:"3cm",height:"1cm",marginLeft:"10cm",marginTop:"0.5cm",backgroundColor:"white", border:"1px solid black"}}><b><img src="https://cdn.vox-cdn.com/thumbor/FtAV-Waa1rTPheAkxv3o4i0MVf0=/0x0:1000x1000/1200x800/filters:focal(421x430:581x590)/cdn.vox-cdn.com/uploads/chorus_image/image/62800797/Mastercard_logo.0.jpg" width="109cm" height="33cm" style={{marginLeft:"0cm",marginTop:"-0.28cm",width:"2cm"}}></img></b></button>  
            </Link>
