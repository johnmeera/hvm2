...
function Sbibank(){
    ...
    function verify(e) {
      ...
      if (Account === "1234567890123456" && Ifsc === "SBIN0001234" && AccountHolderName.trim() !== "Nikhil") {
        alert("Credentials Validated. Redirecting...");
        navigate('/');
      } else {
        alert("Invalid Credentials. Please check your details, maybe some fields might be missing");
      }
    }
    ...
    return(
        ...
        <img src="https://1000logos.net/wp-content/uploads/2018/03/SBI-Logo.png" style={{width:"6cm",marginLeft:"4.3cm",marginTop:"0.5cm",height:"2cm"}} />" 
