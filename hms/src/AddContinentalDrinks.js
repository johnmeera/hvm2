                    ...
                    <div className="additems-container">
                        ...
                        <div className="su" type="Drinks">
                                ...
                                <datalist id="Drinks">
                                    ...
                                    <option value="Blue Lagoun Cocktail">Blue Lagoun Cocktail</option>
                                    <option value="Chapman Drink">Chapman Drink</option>
                                </datalist>
                            </div>
...
export default AddContinentalDrinks;
