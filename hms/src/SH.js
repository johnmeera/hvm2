...
function PS() {
  ...
  const handleSubmit = (e) => {
    ...
    axios.put('http://localhost:8080/api-v1/update/5', formData)
      .then(response => {
  ...
  return (
    <>
       ...
       <img  className="img31" src="https://ik.imagekit.io/pu0hxo64d/uploads/gallery/outdoor-sitting-arrangement-at-hotel-taj-tristar---conference-hall-838.jpg" alt="loading.." width="50cm" height="30cm" style={{ marginLeft: "25cm", marginTop: "4cm", float: "inline-end", marginRight: "1cm",width:"11cm", height:"8cm" }} /><br /> 
